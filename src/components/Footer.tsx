            ...
            <div className="flex flex-row w-full max-w-screen-lg mx-auto gap-6 p-4 sm:p-6 justify-between">
                <div className="flex flex-row sm:flex-col gap-x-3">
                    <Link href="https://discord.gg/jUFET2fN3p" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-md font-semibold hover:fill-red-500 hover:text-red-500 transition-colors">
                        <svg className='h-5 w-5 sm:h-3 sm:w-3 fill-current' viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                            <g>
                    ...
                    <Link href="https://docs.google.com/document/d/1W7JN74MU-9Dbd-9xNnjxE18hQVBPXWuwjK5DGSnuQR4/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-md font-semibold hover:fill-red-500 hover:text-red-500 transition-colors">
                        <FileText className="h-5 w-5 sm:h-3 sm:w-3 fill-current" />
                        <span className="hidden sm:block">Original Spreadsheet</span>
                    </Link>
                </div>
